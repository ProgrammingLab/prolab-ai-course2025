...
# 使い方
v1 = Vector2D(start=[-3, 1], end=[-1, 5], color='r', label='v1')   # 左下から上
v2 = Vector2D(start=[2, -2], end=[5, 0], color='g', label='v2')    # 右下から右上
v3 = Vector2D(start=[-2, -3], end=[0, -1], color='b', label='v3')  # 左下から右上
v4 = Vector2D(start=[1, 3], end=[-1, 1], color='c', label='v4')    # 右上から左上
v5 = Vector2D(start=[1, 1], end=[3, 3], color='k', label='v5')    # 右上から左上

plot_vectors([v1, v2, v3, v4, v5])
